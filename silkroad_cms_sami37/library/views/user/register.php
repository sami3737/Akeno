	...
	<div class="row">
		<form onsubmit="checkRegister();return false;" class="form">
			...
			<div class="form-group">
				...
				<input  type="text" id="usernameInput" class="form-control" value="" pattern=".{3,16}" required title="3 to 16 characters">
			</div>
			...
			<div class="form-group">
				<div class="row">
					<div id="secretcode" class="col-sm-6">
						<label for="secretInput">Secret Code <span class="text-red">*</span></label>
						<input type="number" id="secretInput" class="form-control"  value="" required title="3 to 10 numbers" AUTOCOMPLETE="off">
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="row">
					<div class="col-sm-6">
						...
						<input type="password" id="passwordInput" class="form-control" value="" pattern=".{6,16}" required title="6 to 16 characters" AUTOCOMPLETE="off">
					</div>
					<div class="col-sm-6">
						<label for="password2Input">Confirm Password <span class="text-red">*</span></label>
						<input type="password" id="password2Input" class="form-control" value="" pattern=".{6,16}" required title="6 to 16 characters" AUTOCOMPLETE="off">
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-6">
						<img id="captchaImage" src="<?=$_SESSION['captcha']['image_src']?>">
...
function checkRegister()
{
	...
	var secretinput = jQuery('#secretInput').val();
	...
	jQuery.post('./api/models/checkregisterinputs.php',{username:username1 ,password:password1 ,password2:password2 ,email:email1 ,email2:email2 , secretcode:secretinput,code:entrycaptcha1},
	function(json){
